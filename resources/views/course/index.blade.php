...
@section('content')
    ...
    <section class="all-course">
        <div class="list-course container">
            ...
            {{-- <nav aria-label="Page navigation example link-course">
                <ul class="pagination
                            justify-content-end">
                    <li class="page-item">
                        <a class="page-link color-link course-arrow" href="#" aria-label="Previous">
                            <span aria-hidden="true">&laquo;</span>
                        </a>
                    </li>&nbsp;
                    <li class="page-item"><a class="page-link color-link" href="#"> 1</a></li>&nbsp;
                    <li class="page-item"><a class="page-link color-link" href="#"> 2</a></li>&nbsp;
                    <li class="page-item"><a class="page-link color-link" href="#"> 3</a></li>&nbsp;
                    <li class="page-item">
                        <a class="page-link color-link course-arrow" href="#" aria-label="Next">
