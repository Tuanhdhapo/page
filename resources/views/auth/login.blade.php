    ...
    <form class="login" method="POST" action="{{route('login')}}">
        @csrf
            ...
            <div class="login-check">
                <input type="checkbox" class="form-check-input remember-me-login-checkbox"
                    id="remember-me-login-checkbox">
                <label class="form-check-label remember-me-label rememberme" for="remember-me-login-checkbox">Remember me</label>
            ...
            <p class="text-center">
                <button type="button" class="btn btn-primary facebook"><img class="img-gg"
                        src="{{asset('images/google.png')}}" alt="facebook"><img
                        class="img-gg" src="{{asset('images/vectort.png')}}" alt="google">Google</button>
            </p>
            <p class="text-center">
