    ...
    <div class="banner-hapo">
        <div class="banner">
            <div class="info-banner">
                ...
                <p> <a href="/allcourse"><button>Start Learning Now!</button> </a></p>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                @foreach ($mainCourses as $mainCourse)
                    ...
                    <div class="col-xl-4 col-md-4 d-flex justify-content-center">
                        <div class="card-hapo">
                            <img src="{{ $mainCourse->img_path }}" class="card-img-top" alt="hjs" />
                            <div class="card-body">
            ...
            <div class="container-card">
                <div class="row">
                    @foreach ($otherCourses as $otherCourse)
                        <div class="col-xl-4 col-md-4 d-flex justify-content-center">
                            <div class="card-hapo">
                                <img src="{{ $otherCourse->img_path }}" class="card-img-top" alt="css" />
                                <div class="card-body">
